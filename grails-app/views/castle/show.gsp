...
<html>
	...
	<body>
		...
		<div id="show-castle" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:castleInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${castleInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
